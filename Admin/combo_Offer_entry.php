...
<html>
    ...
    <body>
        ...
        <form action="comboOffer.php" method="POST">
                    ...
                    <tr>
                                ...
                                <?php
                                    foreach($combos as $combo)
                                    {
                                        ...
                                        <tr style="font-size: 12px;text-align: center;">
                                            ...
                                            <td><?php echo $combo['quantity'];?></td>
                                            <td><?php echo $combo['mrp'];?></td>
                                            <?php
                                                if(sts=='no')
                                                {
                                                ?>
                        ...
                        <td valign="top">
                            <table width="100%">
                                ...
                                <?php
                                    foreach($authcombo as $comb)
                                    {
                                        //String sts = off.getStatus();
                                        //String combo_id = off.getCombo_id();
                                        ?>
                                        <tr style="font-size: 12px;text-align: center;">
                                            <td><?php echo $comb['combo_id'];?></td>
                                            <td><?php echo $comb['combo_name'];?></td>
                                            <td><?php echo $comb['quantity'];?></td>
                                            <td><?php echo $comb['mrp'];?></td>
                                            <td>(&#10004;)</td></tr>
                                        <?php
                                    }
                                ?>
