...
<nav class="navbar navbar-default vs">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <li><label id="sv" style="margin-top:15%;color:black;"><?php echo $df['cname']?></label></li>
	  <li>
...
<!--<input type="submit" name="getPay" value="Payment Deails" />
</form>-->
